...
const already_been_in_here = "ALREADY_BEEN_IN_PZC4"
...
func get_normal_dialogue(pitch):
	return {
		"begin" : [
			"TEXT", "It's pathetic, really.", 0.03,
...
func _on_UpperTZ_transition_triggered():
	Transition.go_to("res://Levels/0.0 Cave/PuzzleCave5.tscn", "bottom")

func _on_LowerTZ_transition_triggered():
	Transition.go_to("res://Levels/0.0 Cave/PuzzleCave3.tscn", "top")
